...
| <a id="latex_serve_web-open_on_start"></a>open_on_start |  If True, open the preview in the system default web browser once the server starts. The plain http URL is always printed regardless, so you can open it however you prefer.   | Boolean | optional |  `False`  |
